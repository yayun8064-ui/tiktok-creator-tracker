# Claude × 飞书｜TikTok 达人数据自动日报/周报分析 | 运营必备
...
| 📬 **每日卡片日报** | 每天 10:00 自动推送，含总播放、Top 账号排名、视频明细、停更预警，**含环比昨日涨跌（绿色 +% / 红色 -%）** |
| 📈 **卡片式周报** | 一句话触发，从底表聚合出周报卡片，**含环比上期对比**，不额外消耗 API 配额 |
...
├──────────────────────────────────────────────────┤
│  共 6 位作者监控｜今日发布 3 条                   │
│  总播放 1.54w  +12.3%↑｜点赞 1,620  -3.1%↓      │
├──────────────────────────────────────────────────┤
│  🏆 今日 Top 播放（新发视频）                      │
│  ──────────────────────────────────────────────  │
│  #1  @creator_a   粉丝 66.1w   VV 1.39w  +8.5%↑  │
│  #2  @creator_b   粉丝  1.2w   VV 1,075  +2.1%↑  │
│  #3  @creator_c   粉丝  0.1w   VV   427  -5.3%↓  │
├──────────────────────────────────────────────────┤
│  📋 今日视频明细                                   │
│  账号 · 时间 · VV · 环比 · Like · 评论 · 内容     │
├──────────────────────────────────────────────────┤
...
├──────────────────────────────────────────────────┤
│  7天｜发布 13 条｜总VV 6.16w  +18.4%↑            │
│  点赞 7,086  +9.2%↑｜评论 290  +5.5%↑           │
├──────────────────────────────────────────────────┤
│  📋 本期账号概览（含环比上期）                     │
│  账号 · 发布 · 总VV · 环比 · Like · 评论          │
│  creator_a  ·  5  · 4.21w · +22.3%↑ · 5,120 · 210│
│  creator_b  ·  4  · 1.23w ·  -8.1%↓ · 1,200 ·  56│
│  creator_c  ·  4  · 0.72w · +31.0%↑ ·   766 ·  24│
├──────────────────────────────────────────────────┤
│  🔥 爆款 Top 3                                    │
